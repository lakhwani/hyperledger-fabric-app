...
1. Deploy one of the smart contract implementations (from the `test-network` folder).
   ...
   - To deploy the **TypeScript** chaincode implementation:
     ...
     ```shell
     ./network.sh deployCC -ccn basic -ccp ../app/chaincode-typescript/ -ccl typescript
     ```

   - To deploy the **JavaScript** chaincode implementation:

     ```shell
     ./network.sh deployCC -ccn basic -ccp ../app/chaincode-javascript/ -ccl javascript
     ```

   - To deploy the **Go** chaincode implementation:

     ```shell
     ./network.sh deployCC -ccn basic -ccp ../app/chaincode-go/ -ccl go
     ```

   - To deploy the **Java** chaincode implementation:
     ```shell
     ./network.sh deployCC -ccn basic -ccp ../chaincode-java/ -ccl java
     ```

1. Run the application (from the `app` folder).
